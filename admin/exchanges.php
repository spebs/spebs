...
elseif(isset($_GET['v']) && !isset($_GET['p']))
	...
	$q_centers = "SELECT id, longitude, latitude, AsText(SHAPE) polygon, polygon_type type FROM local_exchange WHERE polygon_type='real' AND Intersects($viewportpolygon, SHAPE)";
